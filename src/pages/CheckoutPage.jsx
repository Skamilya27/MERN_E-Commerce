    ...
    <div className= "mx-auto my-4 max-w-4xl md:my-6">
      <div className="bg-white overflow-hidden  rounded-xl shadow">
        <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <form>
                    <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                      ...
                      <div className="mt-10 flex justify-end border-t border-gray-200 pt-6">
                        <button
                          type="button"
                          className="rounded-md bg-indigo-600 px-3 w-full py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                        >
                          Make payment
                        </button>
                      </div>
          ...
          {/* Product List */}
          <div className="bg-slate-50 px-5 py-6 md:px-8">
            <div className="flow-root">
